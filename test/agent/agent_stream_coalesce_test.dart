...
void main() {
  ...
  test(
    'a burst of text deltas coalesces to a handful of notifications',
    () async {
      var notifications = 0;
  ...
  test(
    'a pending delta notification still fires without a structural event',
    () async {
      var notifications = 0;
      chat.addListener(() => notifications++);
  ...
  test(
    'structural events notify immediately, not on the delta timer',
    () async {
      var notifications = 0;
      chat.addListener(() => notifications++);
